...
RIBASIM_DLL_DEP_DIR_DEVEL='${IMOD_COLLECTOR_DEVEL}/ribasim'
RIBASIM_DLL_DEP_DIR_REGRESSION='${IMOD_COLLECTOR_REGRESSION}/ribasim'
RIBASIM_DLL_DEVEL='${IMOD_COLLECTOR_DEVEL}/ribasim/libribasim.dll'
RIBASIM_DLL_REGRESSION='${IMOD_COLLECTOR_REGRESSION}/ribasim/libribasim.dll'
```

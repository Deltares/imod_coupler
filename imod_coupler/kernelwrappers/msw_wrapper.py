...
class MswMultiWrapper:
    models: dict[str | None, MswWrapper] = {}
    model_names: list[str] = []
    working_dirs: dict[str | None, str | Path] = {}

...
class ExchangeBalance:
    ...
    def compute_realised(self, realised: NDArray[np.float64]) -> None:
        ...
        self._check_valid_shortage(shortage)        # use a numpy isclose to set the max non-zero value

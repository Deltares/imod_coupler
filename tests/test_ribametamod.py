...
def test_metamod(
    ...
    toml_path = path_dev / "imod_coupler_metamod.toml"
...
def test_ribamod(
    ...
    toml_path = path_dev / "imod_coupler_ribamod.toml"
    modflow6_dll = modflow_dll_devel
    modflow6_model_dir = path_dev / "modflow6"

    write_ribamod_toml(
        path_dev,
        "imod_coupler_ribamod.toml",
        modflow6_dll,
        modflow6_model_dir,
        ribasim_dll_devel,
...
def write_metamod_toml(
    ...
    with open(tmp_path_dev / toml_name, "wb") as f:

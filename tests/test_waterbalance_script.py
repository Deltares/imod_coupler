...
def test_waterbalance_script(
    ...
    create_waterbalance_file(
        test_data_folder.joinpath("tmodel_example_output/FlowFM_his.nc"),
        test_data_folder.joinpath("tmodel_example_output/tot_svat_dtgw.csv"),
        test_data_folder.joinpath("tmodel_example_output/T-MODEL-D.LST"),

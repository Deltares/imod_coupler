...
def case_tmodel_f_without_dflow_with_sprinkling(test_data_folder: Path)-> Tuple[Path, Set[str], str, str, Dict[str, Tuple[float, float]]]:

    tmodel_input_folder = test_data_folder / "t_model_f_sprinkling"
    files_to_skip = {
        "msw_ponding_to_dfm_2d_dv_dmm",
        "dfm_2d_waterlevels_to_msw_h_dmm",
        "mf6_river2_to_dmf_1d_q_dmm",
    ...
    csv_reference_file = "waterbalance_tmodel_f_without_dflow_with_sprinkling.csv"
    tolerance_balance = default_tolerance_balance

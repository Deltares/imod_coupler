...
def test_initialize(libribasim, ribasim_basic_model, tmp_path_dev):
    # , libribasim,
    ribasim_basic_model.write(tmp_path_dev / "ribasim.toml")
    config_file = str(tmp_path_dev / "ribasim.toml")
    libribasim.initialize(config_file)


def test_get_start_time(libribasim, ribasim_basic_model, tmp_path_dev):
    ribasim_basic_model.write(tmp_path_dev / "ribasim.toml")
    config_file = str(tmp_path_dev / "ribasim.toml")
    libribasim.initialize(config_file)
...
def test_get_current_time(libribasim, ribasim_basic_model, tmp_path_dev):
    ribasim_basic_model.write(tmp_path_dev / "ribasim.toml")
    config_file = str(tmp_path_dev / "ribasim.toml")
    libribasim.initialize(config_file)
...
def test_get_end_time(libribasim, ribasim_basic_model, tmp_path_dev):
    ribasim_basic_model.write(tmp_path_dev / "ribasim.toml")
    config_file = str(tmp_path_dev / "ribasim.toml")
    libribasim.initialize(config_file)
...
def test_update(libribasim, ribasim_basic_model, tmp_path_dev):
    ribasim_basic_model.write(tmp_path_dev / "ribasim.toml")
    config_file = str(tmp_path_dev / "ribasim.toml")
    libribasim.initialize(config_file)
    libribasim.update()
...
def test_update_until(libribasim, ribasim_basic_model, tmp_path_dev):
    ribasim_basic_model.write(tmp_path_dev / "ribasim.toml")
    config_file = str(tmp_path_dev / "ribasim.toml")
    libribasim.initialize(config_file)
    expected_time = 60.0
...
def test_update_subgrid_level(libribasim, ribasim_basic_model, tmp_path_dev):
    ribasim_basic_model.write(tmp_path_dev / "ribasim.toml")
    config_file = str(tmp_path_dev / "ribasim.toml")
    libribasim.initialize(config_file)
...
def test_get_var_type(libribasim, ribasim_basic_model, tmp_path_dev):
    ribasim_basic_model.write(tmp_path_dev / "ribasim.toml")
    config_file = str(tmp_path_dev / "ribasim.toml")
    libribasim.initialize(config_file)
...
def test_get_var_rank(libribasim, ribasim_basic_model, tmp_path_dev):
    ribasim_basic_model.write(tmp_path_dev / "ribasim.toml")
    config_file = str(tmp_path_dev / "ribasim.toml")
    libribasim.initialize(config_file)
...
def test_get_var_shape(libribasim, ribasim_basic_model, tmp_path_dev):
    ribasim_basic_model.write(tmp_path_dev / "ribasim.toml")
    config_file = str(tmp_path_dev / "ribasim.toml")
    libribasim.initialize(config_file)
...
def test_get_value_ptr_basin(libribasim, ribasim_basic_model, tmp_path_dev):
    ribasim_basic_model.write(tmp_path_dev / "ribasim.toml")
    config_file = str(tmp_path_dev / "ribasim.toml")
    libribasim.initialize(config_file)
...
def test_get_value_ptr_subgrid(libribasim, ribasim_two_basin_model, tmp_path_dev):
    ribasim_two_basin_model.write(tmp_path_dev / "ribasim.toml")
    config_file = str(tmp_path_dev / "ribasim.toml")
    libribasim.initialize(config_file)

    initial_subgrid_level = np.copy(libribasim.get_value_ptr("basin.subgrid_level"))
    ...
    # Subgrid level
    libribasim.update_subgrid_level()
    updated_subgrid_level = libribasim.get_value_ptr("basin.subgrid_level")
...
def test_get_value_ptr_allocation(libribasim, ribasim_user_demand_model, tmp_path_dev):
    ribasim_user_demand_model.write(tmp_path_dev / "ribasim.toml")
    config_file = str(tmp_path_dev / "ribasim.toml")
    libribasim.initialize(config_file)
...
def test_err_unknown_var(libribasim, ribasim_basic_model, tmp_path_dev):
    """
    ...
    error_message = re.escape(
        f"BMI exception in get_var_type(c_char_p(b'{variable_name}'), &c_char_Array_51(b'')):"
...
def test_get_version(libribasim, ribasim_basic_model, tmp_path_dev):
    ribasim_basic_model.write(tmp_path_dev / "ribasim.toml")
    toml_path = tmp_path_dev / "ribasim.toml"
    with open(toml_path, mode="rb") as fp:
        config = tomli.load(fp)
    libribasim.initialize(str(toml_path))
    assert libribasim.get_version() == config["ribasim_version"]


def test_execute(libribasim, ribasim_basic_model, tmp_path_dev):
    ribasim_basic_model.write(tmp_path_dev / "ribasim.toml")
    config_file = str(tmp_path_dev / "ribasim.toml")

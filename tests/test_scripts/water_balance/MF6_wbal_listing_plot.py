...
while True:
    ...
    if "IN:" in line:
        ...
        while True:
            ...
            data_out = append_items_dict_list(
                data_out, line_list[6] + "_IN", line_list[5]
            )
            data_out_cummulative = append_items_dict_list(
                data_out_cummulative, line_list[6] + "_IN", line_list[2]
            )
    elif "TOTAL IN" in line:
        line_list = line.split()
        data_out = append_items_dict_list(data_out, "TOTAL_IN", line_list[7])
        data_out_cummulative = append_items_dict_list(
            data_out_cummulative, "TOTAL_IN", line_list[3]
        )
    elif "OUT:" in line:
        line = file_in.readline()
        while True:
            ...
            data_out = append_items_dict_list(
                data_out, line_list[6] + "_OUT", "-" + line_list[5]
            )
            data_out_cummulative = append_items_dict_list(
                data_out_cummulative, line_list[6] + "_OUT", "-" + line_list[2]
            )
    elif "TOTAL OUT" in line:
        line_list = line.split()
        data_out = append_items_dict_list(data_out, "TOTAL_OUT", line_list[7])
        data_out_cummulative = append_items_dict_list(
            data_out_cummulative, "TOTAL_OUT", line_list[3]
        )
    elif "IN - OUT" in line:
        line_list = line.split()
        data_out = append_items_dict_list(data_out, "TOTAL_IN-OUT", line_list[9])
        data_out_cummulative = append_items_dict_list(
            data_out_cummulative, "TOTAL_IN-OUT", line_list[4]
        )

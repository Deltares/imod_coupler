...
object IMODCollector_X64development : BuildType({
    ...
    steps {
        script {
            ...
            scriptContent = """
                mkdir modflow6
                curl -O https://water.usgs.gov/water-resources/software/MODFLOW-6/mf6.6.3_win64.zip
                unzip  -j -q "mf6.6.3_win64.zip" -d modflow6 mf6.6.3_win64/bin/libmf6.dll 2> NUL
            """.trimIndent()
        }
        script {

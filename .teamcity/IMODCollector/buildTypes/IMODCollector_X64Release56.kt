...
object IMODCollector_X64Release56 : BuildType({
    name = "x64_Release5.6"
    ...
    steps {
        script {
            ...
            scriptContent = """
                ...
                call conda env create --file coupler/environment-minimal.yml -p "%conda_env_path%"
            """.trimIndent()
        }
        script {
    ...
    dependencies {
        dependency(AbsoluteId("MSWMOD_MetaSWAP_MetaSWAPReleaseImod56")) {
            snapshot {
        ...
        dependency(AbsoluteId("MetaSWAP_Modflow_Modflow6Release642")) {
            ...
            artifacts {
                artifactRules = "MODFLOW6.zip!/libmf6.dll"
            }
        }
    }

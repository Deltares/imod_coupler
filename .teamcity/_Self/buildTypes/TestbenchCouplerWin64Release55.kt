...
object TestbenchCouplerWin64Release55 : BuildType({
    name = "Testbench Coupler Win64 Release 5.5"
    ...
    vcs {
        ...
        root(_Self.vcsRoots.ImodCouplerImod55, ". => imod_coupler")
    }
    ...
    dependencies {
        dependency(IMODCollector.buildTypes.IMODCollector_X64Release55) {
            snapshot {
